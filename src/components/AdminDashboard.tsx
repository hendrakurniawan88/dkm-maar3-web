          ...
          <div className="max-w-md mx-auto bg-white dark:bg-slate-950 p-8 rounded-3xl border border-gray-100 dark:border-slate-800 shadow-2xl relative overflow-hidden text-left">
            ...
            <div className="space-y-4">
              ...
              <button
                ...
                className="w-full py-3 px-4 rounded-xl border border-gray-200 dark:border-slate-800 bg-white hover:bg-slate-50 dark:bg-slate-900 dark:hover:bg-slate-850 text-gray-700 dark:text-gray-200 font-bold text-xs uppercase tracking-wider transition-colors shadow-sm flex items-center justify-center space-x-2 cursor-pointer"
              >
              ...
              <div className="flex items-center justify-center space-x-2 my-4">
                <div className="h-[1px] bg-gray-200 dark:bg-slate-800 flex-grow" />
              ...
              <form onSubmit={handleLogin} className="space-y-4">
                ...
                <button
                  ...
                  className="w-full py-2.5 rounded-xl border border-dashed border-emerald-650/30 text-emerald-600 dark:text-amber-400 hover:bg-emerald-500/5 text-xs font-semibold cursor-pointer"
                >
